            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.uploadFiles') }}">{{ __('Uploaded files') }}</a>
                        </li>
                    </ul>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="{{ route('admin.report',['type'=>'excel']) }}">Excel</a>, <a href="{{ route('admin.report',['type'=>'pdf']) }}">PDF</a>
                </div>
